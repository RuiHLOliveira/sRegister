 ...
 */
final class Version20210307135111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD notebook_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_CFBDFA14F74303D6 ON note');
        $this->addSql('ALTER TABLE note DROP notebook_id');
    }
}
