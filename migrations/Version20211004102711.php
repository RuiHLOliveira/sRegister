 ...
 */
final class Version20211004102711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE note (id SERIAL NOT NULL, user_id INT NOT NULL, notebook_id INT NOT NULL, name VARCHAR(255) NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE notebook (id SERIAL NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_F67D9A2BA76ED395 ON notebook (user_id)');
        $this->addSql('CREATE TABLE project (id SERIAL NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, duedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, completed BOOLEAN DEFAULT \'false\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEA76ED395 ON project (user_id)');
        $this->addSql('CREATE TABLE situation (id SERIAL NOT NULL, user_id INT DEFAULT NULL, situation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_EC2D9ACAA76ED395 ON situation (user_id)');
        $this->addSql('CREATE TABLE task (id SERIAL NOT NULL, user_id INT NOT NULL, situation_id INT DEFAULT NULL, project_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, duedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, completed BOOLEAN DEFAULT \'false\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_access (id SERIAL NOT NULL, user_id INT NOT NULL, hash VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, login_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_usage_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, refresh_token VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
